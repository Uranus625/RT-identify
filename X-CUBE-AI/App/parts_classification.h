...
#ifndef __AI_PARTS_CLASSIFICATION_H__
#define __AI_PARTS_CLASSIFICATION_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_PARTS_CLASSIFICATION_MODEL_NAME          "parts_classification"

#define AI_PARTS_CLASSIFICATION_ACTIVATIONS_ALIGNMENT   (4)

#define AI_PARTS_CLASSIFICATION_IN_NUM       (1)
#define AI_PARTS_CLASSIFICATION_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 64, 64, 3, 1, NULL), \
}
#define AI_PARTS_CLASSIFICATION_IN_SIZE { \
  (64 * 64 * 3), \
}
#define AI_PARTS_CLASSIFICATION_IN_1_SIZE  (64 * 64 * 3)
#define AI_PARTS_CLASSIFICATION_IN_1_SIZE_BYTES  ((64 * 64 * 3) * 1)





#define AI_PARTS_CLASSIFICATION_OUT_NUM      (1)
#define AI_PARTS_CLASSIFICATION_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 3, 1, NULL), \
}
#define AI_PARTS_CLASSIFICATION_OUT_SIZE { \
  (1 * 1 * 3), \
}
#define AI_PARTS_CLASSIFICATION_OUT_1_SIZE  (1 * 1 * 3)
#define AI_PARTS_CLASSIFICATION_OUT_1_SIZE_BYTES  ((1 * 1 * 3) * 1)

#define AI_PARTS_CLASSIFICATION_N_NODES (21)

AI_API_DECLARE_BEGIN

/*!
 * @defgroup parts_classification
 ...
 * @ref ai_parts_classification_create. Both the activations memory buffer 
 ...
 * using @ref ai_parts_classification_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_PARTS_CLASSIFICATION_*
 * defines into file @ref parts_classification.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_parts_classification_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_PARTS_CLASSIFICATION_H__*/
